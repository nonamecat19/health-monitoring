  ...
  return (
    <>
      ...
      <View style={style.bottom}>
        <BottomNavigation selectedIndex={selectedIndex} onSelect={changeTabHandle}>
          <BottomNavigationTab icon={GetEvaIcon('list-outline')} title="USERS" />
          <BottomNavigationTab icon={GetEvaIcon('credit-card-outline')} title="ORDERS" />
          <BottomNavigationTab icon={GetEvaIcon('activity-outline')} title="TRANSACTIONS" />
        </BottomNavigation>
      </View>
    </>
  )
